...
* [Standalone Java read from folder + Maven](https://github.com/Visual-Regression-Tracker/examples-java/blob/master/standalone-from-folder-maven)
* [JDI Light + TestNg](https://github.com/Visual-Regression-Tracker/examples-java/blob/master/jdi-light-testng)
